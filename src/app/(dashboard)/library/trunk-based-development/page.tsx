    ...
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="border-b border-[#e5e5e5] px-8 py-14" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-3xl mx-auto flex flex-col gap-5">
          ...
          <h1 className="text-4xl text-black tracking-tight leading-tight" style={{ ...syne.style, fontWeight: 800 }}>Trunk-Based Development</h1>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>In this video: why long-lived branches destroy flow, how trunk-based development works in practice, and how feature flags replace long-lived branches.</p>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              {[
                ...
                <div key={s.stat} className="p-5 border border-[#e5e5e5] text-center" style={{ backgroundColor: "#ffffff" }}>
                  <p className="text-3xl font-mono font-bold" style={{ ...syne.style, color: s.color }}>{s.stat}</p>
