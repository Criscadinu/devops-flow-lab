    ...
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="border-b border-[#e5e5e5] px-8 py-14" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-3xl mx-auto flex flex-col gap-5">
          ...
          <h1 className="text-4xl text-black tracking-tight leading-tight" style={{ ...syne.style, fontWeight: 800 }}>Telemetry and Observability</h1>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>In this video: the three pillars of observability, the four golden signals, and how to instrument a Node.js application.</p>
        </div>
      </div>
