  ...
  return (
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          <p className="text-xs font-mono font-bold uppercase tracking-[0.2em] text-[#0891b2] mb-3">
            Video Lesson
          </p>
          <div
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>
            In this video: what a value stream is, how to identify one in your own team, and how to measure flow efficiency.
          </p>
        </div>
      </div>
