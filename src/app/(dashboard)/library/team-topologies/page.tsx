    ...
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="border-b border-[#e5e5e5] px-8 py-14" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-3xl mx-auto flex flex-col gap-5">
          ...
          <h1 className="text-4xl text-black tracking-tight leading-tight" style={{ ...syne.style, fontWeight: 800 }}>Team Topologies</h1>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>In this video: Conway's Law explained, the four team types, and why most DevOps problems are actually team topology problems.</p>
        </div>
      </div>
                ...
                <div key={team.id} className="border border-[#e5e5e5] overflow-hidden">
                  <div className="px-6 py-5" style={{ backgroundColor: team.bg, borderLeft: `3px solid ${team.color}` }}>
                    <div className="flex items-baseline gap-3 mb-2">
                      ...
                      <p className="text-sm font-bold text-black" style={{ ...syne.style }}>{team.title}</p>
