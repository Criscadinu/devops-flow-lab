      ...
      {ways.map((w, i) => (
        <div key={w.num} className="p-6" style={{ backgroundColor: w.bg, borderRight: i < 2 ? "1px solid #e5e5e5" : undefined }}>
          <div className="flex items-baseline gap-2 mb-3">
            <span className="text-2xl font-mono font-bold" style={{ ...syne.style, color: `${w.color}40` }}>{w.num}</span>
            <div>
              <p className="text-sm font-bold" style={{ ...syne.style, color: w.color }}>{w.title}</p>
    ...
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="border-b border-[#e5e5e5] px-8 py-14" style={{ backgroundColor: "#ffffff" }}>
        <div className="max-w-3xl mx-auto flex flex-col gap-5">
          ...
          <h1 className="text-4xl text-black tracking-tight leading-tight" style={{ ...syne.style, fontWeight: 800 }}>The Three Ways</h1>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>In this video: the Three Ways explained, why they are principles not practices, and how they show up in the Nexus Corp missions.</p>
        </div>
      </div>
