    ...
    <main className="min-h-screen" style={{ backgroundColor: "#fafaf8", color: "#0a0a0a", ...serif }}>
      ...
      <div className="px-8 py-10 border-b border-[#e5e5e5]">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xs mt-3" style={{ ...serif, color: "#888" }}>In this video: why blame kills learning, how to run a blameless postmortem, and how to write action items that prevent recurrence.</p>
        </div>
      </div>
