        ...
        curl --fail http://localhost:3001/health || exit 1`}</CodeBlock>
          ...
          {!task1Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Staging deploys automatically on every green commit to main</span>
            </label>
          )}
        </TaskCard>
        ...
        curl --fail http://localhost:3002/health || exit 1`}</CodeBlock>
          ...
          {!task2Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Production deployment requires approval — pipeline does the work, human approves</span>
            </label>
          )}
        </TaskCard>
...
curl http://localhost:3002/health`}</CodeBlock>
          ...
          {!task3Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Health check verifies deployment succeeded — failed health check fails the pipeline</span>
            </label>
          )}
        </TaskCard>
...
- DEPLOYED_BY=\${GITHUB_ACTOR:-local}`}</CodeBlock>
          ...
          {!task4Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">GET /api/deployment returns deployment metadata</span>
            </label>
          )}
        </TaskCard>
          ...
          {!task5Done && (
            <div className="flex flex-col gap-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Pipeline is green — deploy stages are integrated</span>
              </label>
            </div>
          )}
        </TaskCard>
