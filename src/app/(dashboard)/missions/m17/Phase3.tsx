        ...
        options:
          ...
          {!task1Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">workflow_dispatch trigger added — manual deployment button visible in Actions tab</span>
            </label>
          )}
        </TaskCard>
        ...
        echo "Deploy complete."`}</CodeBlock>
          ...
          {!task2Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Deployment job added — runs automatically after green tests on main</span>
            </label>
          )}
        </TaskCard>
        ...
        git push origin --tags`}</CodeBlock>
          ...
          {!task3Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Deployment creates a Git tag — every deployment is recorded</span>
            </label>
          )}
        </TaskCard>
...
The pipeline enforces all safety checks.`}</CodeBlock>
          ...
          {!task4Done && (
            <label className="flex items-center gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">DEPLOYMENT.md created — anyone can deploy by following the guide</span>
            </label>
          )}
        </TaskCard>
          ...
          {!task5Done && (
            <div className="flex flex-col gap-3">
              ...
              <label className="flex items-center gap-3 cursor-pointer group">
                ...
                <span className="text-sm text-gray-400 group-hover:text-gray-600 transition-colors">Pipeline is green — self-service deployment is live</span>
              </label>
            </div>
          )}
        </TaskCard>
