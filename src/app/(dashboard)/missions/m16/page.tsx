...
export const metadata: Metadata = {
  title: "M-16 Single Repository of Truth - DevOps Flow Lab",
}
        ...
        <section className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-0 border border-gray-800">
            {[
              ...
              >
                <span className="text-xs font-mono font-bold shrink-0 w-48" style={{ color: "rgb(6,182,212)" }}>
                  {row.item}
                </span>
    ...
    <div className="flex-1 px-6 py-14">
      <div className="max-w-5xl mx-auto flex flex-col gap-16">
        ...
        <section className="flex flex-col gap-4 border-t border-gray-900 pt-10">
          ...
          <p className="text-xs font-mono text-gray-700">M-03 unlocks when you complete FOUNDATIONS</p>
        </section>
