      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-14">
        ...
        <section className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-0 border border-gray-800">
            <div className="grid grid-cols-3 gap-4 px-5 py-3 border-b border-gray-800" style={{ backgroundColor: "var(--bg-card)" }}>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div
                ...
                style={{ backgroundColor: "var(--bg-card)", borderColor: "var(--border)", borderLeft: `3px solid ${row.accent}` }}
              >
