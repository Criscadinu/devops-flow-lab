...
export const metadata: Metadata = {
  title: "M-20 Architecture for Low-Risk Releases - DevOps Flow Lab",
}
          ...
          <div className="border border-gray-800">
            ...
            {patternTable.map((row, i) => (
              <div
                ...
                style={{ backgroundColor: i % 2 === 0 ? "var(--bg-card)" : "var(--bg)" }}
              >
                <span className="col-span-3 text-sm font-mono font-bold text-gray-900">{row.pattern}</span>
            ...
            {doraImpact.map((d) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  <span className="text-lg font-mono font-bold" style={{ fontFamily: "var(--font-heading)", color: "rgb(239,68,68)" }}>
                    {d.before}
                  </span>
                  <span className="font-mono text-gray-700">→</span>
                  <span className="text-lg font-mono font-bold" style={{ fontFamily: "var(--font-heading)", color: "var(--af-orange)" }}>
                    {d.after}
                  </span>
                </div>
