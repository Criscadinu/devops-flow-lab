          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <p className="text-white text-sm font-bold flex-1" style={syne.style}>
                Fork from M-10 with incident process in place
              </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-white text-sm font-bold flex-1" style={syne.style}>
                Feature flags pattern already established (M-07)
              </p>
              <span className="text-xs font-mono" style={{ color: "rgb(34,197,94)" }}>✓ READY</span>
            </div>
            <p className="text-gray-500 text-sm leading-relaxed pl-6">
              You have used environment-variable feature flags since M-07. This mission uses the same pattern for experiments.
            </p>
          </div>
        </div>
