...
export const metadata: Metadata = {
  title: "M-08 Trunk-Based Development - DevOps Flow Lab",
}
      ...
      <div className="max-w-3xl mx-auto flex flex-col gap-14">
        ...
        <section className="flex flex-col gap-5">
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            it is ready. This is why M-11 (Architecture for Low-Risk Releases) is in the same cluster.
          </p>
          <div
    ...
    <div className="flex-1 px-6 py-14">
      <div className="max-w-5xl mx-auto flex flex-col gap-16">
        ...
        <section className="flex flex-col gap-4 border-t border-gray-900 pt-10">
          ...
          <p className="text-xs font-mono text-gray-700">M-09 unlocks when you complete CONTINUOUS_INTEGRATION</p>
        </section>
...
export default async function M08Page({
  ...
  if (phase === 4) {
    ...
    const completed = await prisma.userProgress.findFirst({
      where: { userId: gateUser.id, moduleId: "M-08" },
    })
