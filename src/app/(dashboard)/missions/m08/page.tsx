...
export const metadata: Metadata = {
  title: "M-08 Create Telemetry - DevOps Flow Lab",
}
        ...
        <section className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-0 border border-gray-800">
            {[
              ...
              { label: "Target after M-08", value: "4 hours",  color: "rgb(6,182,212)", note: "Structured logs, health endpoint, error rate visible in /api/metrics." },
            ].map((row, i) => (
              <div
                key={row.label}
