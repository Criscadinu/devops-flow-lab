...
describe('Security: Mission ID validation', () => {
  it('mission IDs follow the expected format', () => {
    const validMissionIds = ['M-01', 'M-02', 'M-03', 'M-05', 'M-06', 'M-07', 'M-14', 'M-15', 'M-16', 'M-04', 'M-20', 'M-23', 'M-24', 'M-17']
...
describe('Security: DORA values are within expected ranges', () => {
  it('CFR values are valid percentages', () => {
    const allMissions = new Set(['M-01', 'M-02', 'M-03', 'M-05', 'M-06', 'M-07', 'M-14', 'M-15', 'M-16', 'M-04', 'M-20', 'M-23', 'M-24', 'M-17'])
