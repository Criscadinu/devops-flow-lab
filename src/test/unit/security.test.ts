...
describe('Security: Mission ID validation', () => {
  it('mission IDs follow the expected format', () => {
    const validMissionIds = ['M-01', 'M-02', 'M-03', 'M-04', 'M-05', 'M-06', 'M-07', 'M-08', 'M-09', 'M-10', 'M-11', 'M-14', 'M-15', 'M-16']
...
describe('Security: DORA values are within expected ranges', () => {
  it('CFR values are valid percentages', () => {
    const allMissions = new Set(['M-01', 'M-02', 'M-03', 'M-04', 'M-05', 'M-06', 'M-07', 'M-08', 'M-09', 'M-10', 'M-11', 'M-14', 'M-15', 'M-16'])
